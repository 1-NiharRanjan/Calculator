...
public class MainActivity extends AppCompatActivity {
    ...
    Button button0, button1, button2, button3, button4, button5, button6,
            ...
            buttonMul, buttonCE, buttonEqual;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonMul = (Button) findViewById(R.id.btn_multi);
        buttonDivision = (Button) findViewById(R.id.btn_divide);
        buttonCE = (Button) findViewById(R.id.btn_c);
        buttonEqual = (Button) findViewById(R.id.btn_equal);
        crunchifyEditText = (TextView) findViewById(R.id.textView2);
